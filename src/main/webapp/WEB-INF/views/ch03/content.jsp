...
<div class="card m-2">
	<div class="card-header">
	   Ch03. 요청 매핑 메소드의 매개변수 (Request Mapping Method Parameter)
	</div>
	<div class="card-body">
		<div class="card m-2">
		   <div class="card-header">
		...
		<div class="card m-2">
		   ...
		   <div class="card-body">            
		      <a href="javascript:method6()" class="btn btn-info btn-sm">AJAX 요청</a>
		      <div id="content" class="mt-2"></div>
		      <script>               
			       function method6() {
			          let data = {param1:"풍경", param2:1, param3:1.1, param4:true, param5:"2021-12-25"};
