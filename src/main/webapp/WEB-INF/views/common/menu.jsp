...
<ul class="nav flex-column">
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch02/content">요청 매핑(처리) 메소드와 다양한 응답 (RequestMapping)</a>
      </h6>
   </li>
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch03/content">요청 매핑(처리) 메소드의 매개변수 (RequestMapping Method Parameter)</a>
      </h6>
   </li>
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch04/content">요청 데이터의 유효성 검사 (Request Data validation)</a>
      </h6>
   </li>
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch06/content">Forward & Redirect</a>
      </h6>
   </li>
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch07/content">모델(데이터) 전달 - Data Delivery</a>
      </h6>
   </li>
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white">
         ...
         <a class="text-white" href="${pageContext.request.contextPath}/ch15/content">트랜젝션</a>
      </h6>
   </li>
</ul>