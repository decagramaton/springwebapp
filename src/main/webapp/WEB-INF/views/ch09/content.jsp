...
<div class="card m-2">
	<div class="card-header">File 업로드 & 다운로드</div>
	<div class="card-body">
		<div class="card">
	       ...
	       <div class="card-body">
	          <form method="post" enctype="multipart/form-data" action="fileuploadDto">
	    ...
	    <div class="card">
	       ...
	       <div class="card-body">
	          <a href="filedownload?saveFileName=${saveFileName}" id="link1" class="btn btn-info btn-sm">파일 다운로드</a>
	          <a href="javascript:filedownload()" class="btn btn-info btn-sm"">파일 보기</a>
	          <hr/>
	          <img src="filedownload?saveFileName=${saveFileName}" id="img1" width="200px" alt="이미지 없음"/>
